...
#define MCCONF_L_MAX_VOLTAGE			135.0	// Maximum input voltage for 150v power stage / 30s max battery (150v power stage solder jumper soldered))
//#define MCCONF_L_MAX_VOLTAGE			73.0	// Maximum input voltage for 80v power stage / 16s max battery (no power stage solder jumper soldered))
#endif
